        ...
        <div className="result_sentences">
          {sentences.map((sentence, index) => (
            <div key={index} className="results_sentence">
              <div className="results_translation">
                {toDisplayText(sentence.translation)}
              </div>
              <div className="results_native">
                {toDisplayText(sentence.sentence)}
              </div>
            </div>
          ))}
        </div>
